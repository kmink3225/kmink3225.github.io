...
- **강건성·교차검증 5종** — 5-fold CV로 **671K BiLSTM이 110M KLUE와 통계적 동급**(96.18%±0.41% vs 96.35%, p=0.73) + **1.48ms 최속 추론**(12.49ms 대비) 발굴; suffix ablation(−51%p), RAG holdout(합성 과적합 가설 기각), 소스별 오류분석, 노이즈플로어로 정확도 상한이 데이터 한계임을 진단.
